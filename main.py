...
Run stages in this order:
  ...
  4. pass-detector    Train and save the XGBoost pass detector (binary)
  5. event-detector   Train and save the multi-class event detector
...
Usage:
  ...
  python main.py event-detector
  python main.py all            # runs all five stages in sequence
"""
...
from driblab.models.event_detector import train_event_detector  # noqa: E402
...
STAGES = {
    ...
    "event-detector": run_event_detector,
}
...
Stages:
  ...
  event-detector   Train and save the multi-class event detector
  all              Run all five stages in sequence
"""
